 ...
 */
    exports.validateBytes = function (data, options) { return validator.validateBytes(data, options); }
 ...
 * @returns {Promise} Promise with validation result in object form.
 */
    exports.validateString = function (json, options) { return validator.validateString(json, options); }
